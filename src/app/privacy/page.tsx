      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-6 text-[#2a211c]/80 leading-relaxed">
          <p>
            ...
            This is a placeholder privacy policy. Webthism will update this page with details on what
            information we collect, how it&apos;s used, and how you can request its removal.
          </p>
          <p>
