  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-[#BD9DFF] selection:text-black">
      ...
      <main className="pt-24 md:pt-32 pb-24 md:pb-48">
        {/* Header */}
        <header className="relative py-12 md:py-24 px-5 md:px-8 mb-10 md:mb-20 text-center overflow-hidden">
            ...
            >
                ...
                <h1 className="font-heading text-4xl sm:text-6xl md:text-9xl font-black tracking-tighter mb-5 md:mb-8 leading-[0.85] text-white">
                    Our <br />
                    <span className="text-[#BD9DFF] italic font-serif">Services</span>
                </h1>
                
                <p className="max-w-xl mx-auto text-[#A1A1AA] text-base md:text-xl font-sans font-extralight italic opacity-80 leading-relaxed px-2">
        ...
        {/* Services Bento Grid */}
        <section className="max-w-7xl mx-auto px-5 md:px-8 relative">
            <CyberneticBentoGrid />
