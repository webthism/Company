...
export const Testimonials = () => {
  return (
    <section id="testimonials" className="relative py-16 md:py-32 bg-black overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-6 relative z-10 text-center mb-10 md:mb-16">
        <motion.h2
        ...
        <p className="max-w-2xl mx-auto text-[#A1A1AA] text-base md:text-xl font-sans font-light leading-relaxed px-2">
      ...
      <div className="mt-10 md:mt-20 text-center relative z-10 px-5">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
            <span className="w-2 h-2 rounded-full bg-[#BD9DFF] animate-pulse" />
            <span className="text-[10px] sm:text-xs font-heading font-medium tracking-widest uppercase text-[#A1A1AA]">
