...
export const Portfolio = () => {
  return (
    <section id="tech-stack" className="relative py-16 md:py-32 bg-black overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-6 relative z-10 text-center">
        ...
        <div className="relative flex size-full max-w-4xl mx-auto items-center justify-center overflow-hidden rounded-2xl md:rounded-3xl bg-white/[0.02] border border-white/10 backdrop-blur-sm p-6 sm:p-10 md:p-20">
