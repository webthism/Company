...
const demoIcons = [
  ...
  { id: 10, icon: IconX, className: 'top-[10%] left-[70%]' },
...
export const Hero = () => {
  return (
    <FloatingIconsHero
      title="Custom Websites That Actually Convert"
      subtitle="Stop losing potential clients to outdated designs. We build high-performance websites that look premium and drive massive results."
